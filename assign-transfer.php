...
$loc=$_GET['loc'];
$remark=$_GET['remark'];
$aboutname=$_SESSION['aboutname'];
$employee=$_GET['employee'];
?>
<script type="text/javascript">
function handleSelect(elm)
{
window.location ="assign-transfer.php?emp_no=<?php echo $emp_no;?>&asno=<?php echo $_GET['asno'];?>&parid=<?php echo $_GET['parid']; ?>&inv_id=&tag_no=&eqdesc=&brand=&serial_no=&model_no=&remark=&employee=<?php echo $aboutname;?>&rad=<?php echo $rad;?>&loc=<?php echo $loc;?>&selection="+elm.value;
}
function handleRadio(elm2)
{
window.location ="assign-transfer.php?emp_no=<?php echo $emp_no;?>&asno=<?php echo $_GET['asno'];?>&parid=<?php echo $_GET['parid']; ?>&inv_id=&tag_no=&eqdesc=&brand=&serial_no=&model_no=&remark=&employee=<?php echo $aboutname;?>&loc=<?php echo $loc;?>&selection=<?php echo $selection;?>&rad="+elm2.value;
}
</script>
</head>
<body>
...
<?php
 ...
 ?>
 <div class="srcdoc">
   <form action="temp_save_transfer.php#srcdocsave" method="POST" class="">
     ...
     <input type="hidden" name="employee" value="<?php echo $aboutname;?>">
     ...
     <span class="span-assign">Last Name:</span><input type="text" name="lname" class="form-control" style="width:130px;margin-bottom:5px;" readonly required value="<?php echo $row['empl_lastname'];?>"><br>
     <span class="span-assign">Assign ID:</span><input type="text" class="form-control" style="width:130px;margin-bottom:5px;" name="assign_id" value="<?php echo $asno;?>" readonly>
     ...
     <span><strong>EQ ID:</strong></span><input type="text" name="inv_id" class="form-control" style="width:130px;" value="<?php echo $inv_id;?>" readonly>
     ...
     <span class="span-assign">EQ Desc. :</span><input type="text" name="eq_desc" class="form-control" style="width:130px;margin-bottom:5px;" readonly  value="<?php echo $eqdesc;?>">
...
?>
<ul>
        <?php echo "<li><a href='assign-transfer.php?emp_no=$emp_no&asno=$asno&parid=$parid&inv_id=&tag_no=&eqdesc=&brand=&serial_no=&model_no=&remark=&employee=$aboutname&date=&rad=$rad&selection=$selection&loc=$location'> $location</a></li>"; ?>
      </ul>
    <?php
  }
}
...
<div class="assign-srcdoc">
  ...
  <td><a href="assign-transfer.php?emp_no=<?php echo $emp_no;?>&asno=<?php echo $_GET['asno'];?>&parid=<?php echo $_GET['parid']; ?>&inv_id=<?php echo $row7['eq_inv_id'];?>&tag_no=<?php echo $row7['tag_no'];?>&ip_add=<?php echo $row7['ip_add'];?>&eqdesc=<?php echo $row7['eqdesc'];?>&brand=<?php echo $row7['brand'];?>&serial_no=<?php echo $row7['serial_no']; ?>&model_no=<?php echo $row7['model_no'];?>&remark=<?php echo $row7['remarks'];?>&employee=<?php echo $aboutname;?>&rad=<?php echo $rad;?>&selection=<?php echo $selection;?>&loc=<?php echo $loc;?>&date=" class="btn btn-outline-primary">Add</a></td>
  </tbody>
  <?php
  }
  ?>
...
<form action="saveassign-transfer.php" method="POST" id="dd">
  <input type="hidden" name="employ" value="<?php echo $employee;?>">
<span class="span-assign">Location :</span><input type="text" class="form-control" name="loc_assign" value="<?php echo $row11['deploy'];?>" readonly style="background-color:#ccc;width:600px;"><br>
...
<input type="submit" class="btn btn-primary" value="SAVE" style="float:right;margin-right:690px;margin-top:20px;height:30px;">
</form>
<form action="canceltransfer.php" method="POST">
 <input type="hidden" name="emptransfer" value="<?php echo $aboutname;?>">
...
<div id="srcdocsave">
  ...
  <tbody>
    <td>
      <form action="removeassign-transfer.php#srcdocsave" method="POST">
        <input type="hidden" name="par_tempassign" value="<?php echo $row8['par_tempassign']; ?>">
        ...
        <input type="hidden" name="aboutname" value="<?php echo $aboutname; ?>">
