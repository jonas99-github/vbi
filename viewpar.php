...
<table style="text-align:center;"><tr>
  ...
  <th width="12%">Issued to</th>
  <th width="12%">Location</th>
      </tr>
      <?php
        $sql="SELECT * FROM prty_ackn_rcpt INNER JOIN empl_tbl on prty_ackn_rcpt.transfer_empl_no=empl_tbl.empl_no WHERE par_no='$par'";
      ...
      <tbody>
        ...
        <td><?php echo $row['empl_firstname']." ".$row['middlename']." ".$row['empl_lastname'];?></td>
        <td><?php echo $row['location_transfer'];?></td>
      </tbody>
      <?php
    }
     ?>
