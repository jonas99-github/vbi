...
$type="Transferred an Equipment";
$pos=$_SESSION['SESS_ROLE'];
date_default_timezone_set('Asia/Manila');
$date=date('F j, Y g:i:a  ');
$sql8="INSERT INTO transac_inv(transac_type,transac_pos,transac_eqid,transac_date,transac_loc,transac_empl,transac_transferredto) VALUES('$type','$pos','$invid','$date','$l','$o','$c')";
