...
{
  window.location ="archive_about.php?section=equipment&action=transfer&emp_no=<?php echo $emp_no;?>&selaction="+elm.value;
}
</script>
</style>
</head>
...
<!--*HR GENERALIST-->
 ...
 <li><a href="archive_about.php?section=overview&action=&selaction=&overview&emp_no=<?php echo $_GET['emp_no']; ?>">About</a><li>
 </ul>
 </div>
 ...
 <h1 style="text-align:center;font-size:23px;">ARCHIVED</h1>
 <img src="icon/prsn2.jpg" height="90" width="90" id="imgprof">
 <?php
 $sql4="SELECT * FROM archive WHERE arch_empl_no='$emp_no'";
 $result4=$conn->query($sql4);
 $row4=$result4->fetch_assoc();
 $show_fname=$row4['arch_firstname'];
 $show_mname=$row4['arch_middlename'];
 $show_lname=$row4['arch_lastname'];
 ...
 <ul class="mainmenu">
 <li><a href="archive_about.php?section=overview&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>">Overview</a></li>
 <li><a href="archive_about.php?section=employee&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>">Employee</a></li>
 <li><a href="archive_about.php?section=equipment&selaction=&action=&emp_no=<?php echo $_GET['emp_no'];?>">Equipment</a></li>
 <li><a href="archive_about.php?section=deployment_history&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>">Deployment</a></li>
 </ul>
 </nav>
 </div>
 <?php
 ...
 <div class="aboutcontent-div">
   <label style="margin-left:15px;color:#878787;">Employee Number: </label><label class="en"><strong><?php echo $row4['arch_empl_no'];?></strong></label><br><br>
   <label style="margin-left:15px;color:#878787;">Position: </label><label class="pos">
   <strong>
     <?php
   $pos3=$row4['arch_position'];
 ...
 <div class="aboutcontent-div">
   ...
   while($row3=mysqli_fetch_assoc($result3)){
     ...
     <label style="margin-left:15px;color:#878787;">First Name: </label><label class="fn"><strong><?php echo $row3['empl_firstname'];?></strong></label><br>
     ...
     <label style="margin-left:15px;color:#878787;">Last Name: </label><label class="ln"><strong><?php echo $row3['empl_lastname'];?></strong></label><br><br>
     <label style="margin-left:15px;color:#878787;">Status: </label><label class="sts"><strong><?php echo $row3['empl_status'];?></strong></label><br>
   ...
   ?><br>
    <label style="margin-left:15px;color:#878787;">Department: </label>
    <?php
   $dept2=$row3['dept_id'];
   ...
   while($row14=mysqli_fetch_assoc($result14)){
    ...
    ?><br>
     <label style="margin-left:15px;color:#878787;">Deployment/Location: </label><label class="dep"><strong><?php echo $row3['deploy'];?></strong></label><br>
     <label style="margin-left:15px;color:#878787;">Date Hired:</label><label class="hd"><?php echo $row3['hired'];?></strong></label><br><br>
     <label style="margin-left:15px;color:#878787;">Profile creation date:</label><label style="margin-left:31px;"><?php echo $row3['date_created'];?></label><br><br>
 ...
 <?php
  ...
  ?>
   <a href="employee.php?emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary">Edit information</button></a>
    <button class="btn btn-danger" onclick="archive(this)" value="<?php echo $emp_no;?>">Transfer to archive</button>
   </div>
 ...
 ?>
 <center><div class="aboutcontent-div">
 <br>
 <table id="prof-equip">
 <tr>
 <th>ID</th>
  ...
  <tbody>
   ...
   <?php
         if($position=='Admin Staff'){
           ?>
      <a href="codegenerate.php"><button class="btn btn-primary" style="float:left">Assign equipment</button></a>
   <?php
       }
       if($position=='IT Admin'){
         ?>
 ...
 <div style="background-color:#1abc9c; padding:10px;margin-top:40px;margin-left:290px;margin-right:100px;margin-bottom:-20px;font-size:20px;font-family:arial;border-top-left-radius: 3px;
 	border-top-right-radius:3px; color:maroon;"><strong>Issued Equipment</strong></div>
 <div class="content-divitadmin"><br>
   <h3 style="text-align:center;">Property Acknowledgement Receipt/Memorandum Receipt</h3><br>
 <br>                    <table class="content-divitadmin">
       <tr>
         <th>UNIQUE ID</th>
         <th>PAR NUMBER</th>
         <th>DATE ISSUED</th>
       ...
       <?php
         ...
         while($row12=mysqli_fetch_assoc($result12)){
           ?>
       <tbody>
         <td><?php echo $row12['par_id'];?></td>
         <td><a href="viewpar.php?par=<?php echo $row12['par_no'];?>"><?php echo $row12['par_no'];?></td>
           <td><?php echo $row12['dateissued'];?></td>
         </tbody>
         <?php
       }
        ?>
...
<form method="POST" action="transfer_remark.php#transferdiv" id="transferForm">
       <tr>
         ...
         <td>
           ...
           <textarea name="remarktransfer"><?php echo $row20['remarkTransfer'];?></textarea>
         </td>
         <td>
...
<div class="first-header">
  <ul>
    <a href="dashboard.php"><img src="icon/logo.png" alt="logo" height="45" width="140" id="imgnav"></a>
...
<ul>
<li><a href="timeline.php?emp_no=<?php echo $_GET['emp_no']; ?>">Timeline</a></li>
<li><a href="archive_about.php?section=overview&emp_no=<?php echo $_GET['emp_no']; ?>">About</a><li>
</ul>
</div>
...
<img src="icon/prsn2.jpg" height="150" width="150" id="imgprof">
<?php
...
<center><h3><?php echo $show_fname; echo " ";echo  $show_mname; echo " "; echo $show_lname;?></h3></center>
<ul class="mainmenu">
<li><a href="archive_about.php?section=overview&emp_no=<?php echo $_GET['emp_no'];?>">Overview</a></li>
<li><a href="archive_about.php?section=employee&emp_no=<?php echo $_GET['emp_no'];?>">Employee</a></li>
<li><a href="archive_about.php?section=equipment&action=&selaction=emp_no=<?php echo $_GET['emp_no'];?>">Equipment</a></li>
<li><a href="archive_about.php?section=deployment_history&emp_no=<?php echo $_GET['emp_no'];?>">Deployment</a></li>
</ul>
</nav>
</div>
<?php
...
if($section=='overview'){
?>
<div class="aboutcontent-div"><br>
<label>Employee Number: </label><label class="en"><strong><?php echo $row4['empl_no'];?></strong></label><br><br>
<label>Position: </label><label class="pos"><strong><?php echo $row4['position'];?></strong></label><br><br>
<label>Department: </label><label class="dt"><strong><?php echo $row5['dept_name'];?></strong></label><br><br>
<label>Deployment: </label><label class="dp"><strong><?php echo $row5['deploy'];?></strong></label><br><br>
<label>Equipment assigned to employee: <br><?php
$sql6="SELECT*FROM eq_inv INNER JOIN eq_desc on eq_inv.eq_desc_id=eq_desc.eq_desc_id WHERE empl_no='$emp_no'";
$result6=mysqli_query($conn, $sql6);
while($row6 = mysqli_fetch_assoc($result6)){
?><strong><?php echo "-".$row6['eqdesc'];?></strong></label><br><?php
}
?><br>
</div>
<div class="aboutcontent-div2">
  <?php
  $sql7="SELECT*FROM eq_inv WHERE empl_no='$emp_no'";
  $result7=$conn->query($sql7);
  $row7=$result7->fetch_assoc();
  ?><br><br>
<h2 style="text-align:center;"><strong>Property Acknowledgement Receipt(s)<strong></h2>

    <label class="pr"><a href="viewpar.php"><strong><?php echo $row7['par'];?></strong></a></label><br><br>
</div>
<?php
}
elseif($section=='employee'){
...
<div class="aboutcontent-div">
<?php
$sql3="SELECT * FROM empl_tbl INNER JOIN dept_tbl on empl_tbl.dept_id=dept_tbl.dept_id WHERE empl_no='$emp_no'";
$result3=$conn->query($sql3);
$row3=$result3->fetch_assoc();
?>
<label>First Name: </label><label class="fn"><strong><?php echo $row3['empl_firstname'];?></strong></label><br>
<label>Middle Name: </label><label class="mn"><strong><?php echo $row3['middlename'];?></strong></label><br>
<label>Last Name: </label><label class="ln"><strong><?php echo $row3['empl_lastname'];?></strong></label><br><br>
<label>Status: </label><label class="sts"><strong><?php echo $row3['empl_status'];?></strong></label><br>
<label>Position: </label><label class="ps"><strong><?php echo $row3['position'];?></strong></label><br>
<label>Department: </label><label class="dept"><strong><?php echo $row3['dept_name'];?></strong></label><br>
<label>Deployment/Location: </label><label class="dep"><strong><?php echo $row3['deploy'];?></strong></label><br>
<label>Date Hired:</label><label class="hd"><?php echo $row3['hired'];?></strong></label><br><br>
<label>Profile creation date:</label><label style="margin-left:31px;"><?php echo $row3['date_created'];?></label><br><br>
<label>Remarks/Comments:</label><label style="margin-left:31px;"><?php echo $row3['remarks_prof'];?></label><br><br>
<a href="employee.php?emp_no=<?php echo $emp_no;?>"><button>Edit information</button></a>
</div>
<?php
}
elseif($section=='equipment'){
...
<?php
$sql2="SELECT * FROM eq_inv INNER JOIN eq_desc on eq_inv.eq_desc_id=eq_desc.eq_desc_id WHERE empl_no='$emp_no'";
$result2=mysqli_query($conn, $sql2);
while($row2 = mysqli_fetch_assoc($result2)){
?>
<tbody>
 <td><?php echo $row2['eq_inv_id']; ?></td>
 <td><?php echo $row2['eqdesc']; ?></td>
 <td><?php echo $row2['tag_no']; ?></td>
 <td><?php echo $row2['serial_no']; ?></td>
 <td><?php echo $row2['model_no']; ?></td>
 <td><?php echo $row2['ip_add']; ?></td>
 <td><?php echo $row2['eq_state']; ?></td>
 <td><?php echo $row2['eq_condition']; ?></td>
 <td><?php echo $row2['date_issued']; ?></td>
 <td><?php echo $row2['date_purch']; ?></td>
 <td><?php echo $row2['price']; ?></td>
 <td><?php echo $row2['curr_equip_loc']; ?></td>
...
<button style="float:left;">Request for equipment transfer</button>
 <br><br><br><br><br><br><br><br><br><br><br>
 <h2>Issued Equipment</h2>
     <h5>Property Acknowledgement Receipt/Memorandum Receipt</h5>
</div></center>
<?php
}
elseif($section=='deployment_history'){
?>
<div id="aboutcontent-div" class="aboutcontent-div">
  <?php
  $sql8="SELECT * FROM empl_tbl WHERE empl_no='$emp_no'";
  $result8=mysqli_query($conn,$sql8);
  while($row8=mysqli_fetch_assoc($result8)){
    ...
    ?>
    <br><br>
  Current employee's deployment/location:<?php echo " ".$row8['deploy'];?>
  <div id="transferform" style="border-style:solid;border-width:2px;border-color:black;margin-top:50px;margin-left:320px;margin-right:320px;padding-bottom:100px;padding:10px;">
    <?php
      $sql9="SELECT * FROM deployment WHERE deployment='$d'";
      $result9=mysqli_query($conn,$sql9);
      while($row9=mysqli_fetch_assoc($result9)){
        ?>
  <form action="saveeditdeploy.php#transferform" method="POST"><br>
    <input type="hidden" name="emp2" value="<?php echo $emp_no;?>">
    <span>Deployment ID </span><input type="text" name="id" value="<?php echo $a;?>" readonly><br><br>
    <span>Deployment </span><br>
    <select name="deploy">
      <?php
      $sql11="SELECT * FROM Deployment WHERE deployment='$d'";
      $result11=mysqli_query($conn,$sql11);
      while($row11=mysqli_fetch_assoc($result11)){
        ?>
      <option><?php echo $row11['deployment'];?></option>
    ...
    ?>
        ...
        while($row10 = mysqli_fetch_assoc($result10)){
        ?>
          <option><?php echo $row10['deployment']; ?></option>
          <?php
        }
        ?>
      </select><br><br>
    <span>Date changed </span><br><input type="date" name="date_changed" style="width:267px;height:30px;"><br><br>
    <input type="submit" name="submit" class="btn btn-primary" value="Change deployment">
</form>
<?php
}
}
...
if($position=='IT Admin'){
         ?>
          ...
          <div class="profile-nav">
            <ul>
            <li><a href="timeline.php?emp_no=<?php echo $_GET['emp_no']; ?>">Timeline</a></li>
            <li><a href="archive_about.php?section=overview&selaction=&action=&emp_no=<?php echo $_GET['emp_no']; ?>">About</a><li>
            </ul>
            </div>
    ...
    <div class="profile-sidenav-about">
    <h1 style="text-align:center;font-size:18px;">ARCHIVED</h1>
    <img src="icon/person.png" height="90" width="90" id="imgprof">
      <?php
      $sql4="SELECT*FROM empl_tbl WHERE empl_no='$emp_no'";
      $result4=$conn->query($sql4);
      $row4=$result4->fetch_assoc();
       ...
       ?>
        <center><h3><?php echo $show_fname; echo " ";echo  $show_mname; echo " "; echo $show_lname;?></h3></center>
          <ul class="mainmenu">
            ...
            if($section=='overview'){
              ?>
            <li style="font-size:20px;"><a href="archive_about.php?section=overview&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>"><strong>Overview</strong></a></li>
            <?php
          }
          else{
          ?>
            ...
            if($section=='employee'){
              ?>
            <li style="font-size:20px;"><a href="archive_about.php?section=employee&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>"><strong>Employee</strong></a></li>
            <?php
          }
          else{
          ?>
           ...
           ?>
            <?php
             if($section=='equipment'){
              ?>
            <li style="font-size:20px;"><a href="archive_about.php?section=equipment&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>"><strong>Equipment</strong></a></li>
            <?php
          }
          else{
          ?>
         ...
         <?php
          if($section=='deployment_history'){
           ?>
         <li style="font-size:20px;"><a href="archive_about.php?section=deployment_history&action=&selaction=&emp_no=<?php echo $_GET['emp_no'];?>"><strong>Deployment</strong></a></li>
         <?php
       }
       else{
       ?>
        <li><a href="archive_about.php?section=&action=&selaction=&section=deployment_history&emp_no=<?php echo $_GET['emp_no'];?>">Deployment</a></li>
       <?php
       }
       ?>
          </ul>
...
<div id="prof-equip">
  ...
  <?php
      ...
      if($position=='IT Admin'){
          if($act==''){
            ?>
              <button class="btn btn-primary" value="<?php echo $emp_no;?>" onclick="transfer(this)" style="float:left;margin-left:2px;height:30px;">Transfer equipment</button>

              <a href="archive_about.php?section=equipment&action=remove&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary" style="float:left;margin-left:2px;margin-right:2px;height:30px;">Remove equipment</button></a>
              <?php
          }
          if($act=='transfer'){
         ?>
            <a href="canceltransfer.php?section=equipment&action=&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary" style="float:left;height:30px;background-color:red;">Cancel Transfer</button></a>
            <a href="archive_about.php?section=equipment&action=remove&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary" style="float:left;height:30px;margin-left:2px;margin-right:2px;">Remove equipment</button></a>
         <?php
       }
       if($act=='remove'){
         ?>
         <a href="archive_about.php?section=equipment&action=transfer&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary" style="float:left;height:30px;margin-left:2px;">Transfer equipment</button></a>
         <a href="archive_about.php?section=equipment&action=&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-primary" style="float:left;background-color:red;height:30px;margin-left:2px;margin-right:2px;">Cancel Removal</button></a>
         <?php
       }
        ?>
                    ...
                    <?php
                     ...
                     ?>
                          ...
                          <br><br><br>
                            ...
                            <form action="savetransfer.php" method="POST" style="margin-bottom:5px;" >
                              <span>Transfer equipment</span><br><br>
                              <?php
                              $sql13="SELECT * FROM addeq_temp WHERE emp_no='$emp_no'";
                              $result13=mysqli_query($conn,$sql13);
                              while($row13=mysqli_fetch_assoc($result13)){
                                echo ">".$row13['invid']."-".$row13['eqdesc']."-".$row13['serial_no']."<br>";
                                $list=$row13['invid'];
                              }
                              ?>
                               <center>
                                 <?php
                                 if(empty($list)){
                                   echo "<i><label style='color:red; font-size:13px;'>--Add Equipment to Transfer--</label></i><br>";
                                 }
                                 ?>
                                 <label>_______________________________</label></center>
                              <span>Employee:</span>
                              ...
                              <div class="input-group mb-3">
                                ...
                                <select name="employeinfo" style="width:260px;" onchange="javascript:handleempl(this)" required class="custom-select" id="inputGroupSelect01">

                                <?php
                                $sql17="SELECT*FROM empl_tbl WHERE empl_no='$selaction'";
                                $result17=mysqli_query($conn,$sql17);
                                while($row17=mysqli_fetch_assoc($result17)){
                                  ?>
                                    <option value="<?php echo $row17['empl_no'];?>"><?php echo $row17['empl_firstname']." ".$row17['middlename']." ".$row17['empl_lastname'];?></option>
                                      <?php
                                    }
                                    ?>
                                      <option></option>
                                    <?php
                              $sql4="SELECT * FROM empl_tbl ORDER BY date_created";
                              $result4=mysqli_query($conn, $sql4);
                              for($i=0; $row4 = mysqli_fetch_assoc($result4); $i++){
                                   ?>
                                   <option value="<?php echo $row4['empl_no'];?>"><?php echo $row4['empl_firstname']." ".$row4['middlename']." ".$row4['empl_lastname'];?></option>
                                   <?php
                                   }
                                        ?>
                              ...
                              <span>Location:</span>
                                <?php
                                $sql15="SELECT*FROM empl_tbl WHERE empl_no='$selaction'";
                                $result15=mysqli_query($conn,$sql15);
                                while($row15=mysqli_fetch_assoc($result15)){
                                  ?>
                              <input type="text" name="locc" class="form-control" readonly value="<?php echo $row15['deploy'];?>" style="background-color:#ccc;">
                              <?php
                            }
                             ?>
                          <br><br>
                              <input type="hidden" name="emp" value="<?php echo $emp_no;?>">
                                ...
                                <input type="date" class="form-control" style="width:180px;" name="date_transfered" required><br><br>
                              <input type="hidden" name="aboutname" value="<?php echo $emp_no;?>">
                              <input type="submit" name="submit" style="height:30px;position:relative;margin-left:350px;"class="btn btn-primary" value="Confirm transfer">
                            </form>
                            <a href="canceltransfer.php?section=equipment&action=&selaction=&emp_no=<?php echo $emp_no;?>"><button class="btn btn-danger" style="height:30px;margin-left:500px;position:relative;margin-top:-68px;position:relative;">Clear selection</button></a>
                          </div>
                                <?php
                          }
                          ?>
...
<br>                    <table class="content-divitadmin">
  ...
  function remove(details){
    if(confirm("You are about to REMOVE an equipment from an employee. Adding back the same equipment will no longer retain its previous PAR number and will produce a different Property Acknowledgement Receipt for that equipment. However, the equipment will be visible in the PAR/MR in the Issued equipment section. Press 'OK' to proceed.")){
  ...
  function archive(archiveDetails){
    ...
    if(confirm("Warning! Archiving the employee will remove it from the employee list and will be transferred to the archive section. Its profile will no longer exist. Press 'OK' to proceed with the profile deletion process.")){
      $.ajax({
